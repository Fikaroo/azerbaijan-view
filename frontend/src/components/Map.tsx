...
const Map = () => {
  ...
  const cities = [
    ...
    ></path>,
    <path
      d="M335.1 557.6l-4 3.9-1.1 6.8 2.4 4.8 3.3 4.9 0.6 7.3 2.6 6.2 5.9 3.5 5.6 4.1-6.9 3.8-6.7 4.4-5.7 6.5-4.9 7.2-6.9-4.2-1.9-16-5.2-0.5-0.2-0.6-2.3-2.3-7.3-5.2-4.1-4.3-1.6-3.3-0.9-3.5-1.3-3.2-2.7-2.2-12.3-5.5-5.6-4.4-2.3-6.9 2.2-5.7 5.4-3.4 12.5-2.3 6.5 4.2 7.7 0.9 6.7-5.2 6.7-4.7 4.2 0.8 4.1 0.7 7.2-1.9 3 2.2 2 3.4-1.6 5.2-3.1 4.5z"
      id="AZE1736"
      name="Qubadli"
    ></path>,
    <path
      d="M336.4 478.8l-1.4 2.3 0.2 2.4 1.6 1.2 2.8-0.1 1.2-1.4 1.7-1 1.8 7.6 0.4 6.3 0.1 4.4-0.1 4.1-4.6 7.5-4.6 7.3-0.9-6.3-2.4-4.8-4.7-0.5-4.6 1.6-5.3 8.9-7.1 0.8-2.9-2.6-3.3-1.6-3.8-1.4-0.7-5.9 2.3-6.1 2.9-5.7-1.1-6.9-1.7-6.9 7.7-1.2 7.1-3.5 7.2-0.9 7.8 1.3 4.4 1.1z"
      id="AZE1737"
      name="Şuşa"
    ></path>,
    <path
      d="M375.3 335.2l2.3 10.4 1.8 2.4 2.4 1.7 3 5.5 4.1 3.7 4.9 1.8-0.7 14.1 0.4 7.7 1 4.1 0.8 4.3-4.8 0.6-4.5-1.4-1.6-5.7-3.2-4.1-3.9 1.7-4.3-0.8-1.8-1.8-2.2-0.8-1.2 2.8 1 3.6-10.7 5.3-9.2 4.2-1.3 7.6-4.4 4.6-2.5 6-0.8 8-4-4.5-2.2-5-2.1-4.5-4.4-3.5-8.5-8.1-10.2-1-3.8 3-3.9 1.2-2.2-6.1-1.5-7.3-1.9-8 0.8-8.2 3.4-2.9 1.1-3.7 0.7-3.9 5.9-7.7 9.4-3.7 8.2-5.2 8.5-3.7 6.4 0.2 6.3-0.2 3.7-2.1 6.8-5.2 3.3-2.1 7.9-7.7 1.3 3.5 0.8 3.7 2.6 3.8 3 3.4z"
      id="AZE1738"
      name="Tərtər"
    ></path>,
    <path
      d="M355.5 473.6l-2.1 3.1-1.5 2.9 2 4.2 8.6 9.4 2.1 8.6-5.3 5-5.8 4.2-4.5-2.5-4.3-3.9 0.1-4.1-0.1-4.4-0.4-6.3-1.8-7.6-3.1-2.6-3-0.8-4.4-1.1-7.8-1.3-7.2 0.9-7.1 3.5-7.7 1.2-2.9-13.9-5.9-12.3-3.6-3.4-3.9-2.6-1.3-5.7 2.3-6.7 10-6.1 5.2 2.6 4.6 3.4 5.3-3.1 3.8-5.6 6.2-3.3 7.1-1.3 6 4.5 7-2 8.2 4.2 4.3 9.9 6 5.6 7 3.3-1.5 6-3.5 4.6-3.8 6.6-3.3 6.9z m-12.7-2.9l2.4-6.3 1.5-0.2 0.6-1.7-1.3-2.6-3-1.4-1.2 0.7-2.5 2.2-2.9 4.1 0.5 5.2 2.7 1.9 3.2-1.9z"
      id="AZE1739"
      name="Xocalı"
    ></path>,
    <path
      d="M357.8 612.9l-2.6 2.1-2.4 2.7-4.3 7.7-1 1.3-1.4 1.1-2.8 1.6-1.3 1.1-2.1 3.2-2.8 6.7-2.8 2.7-9.9 5-3.1 2.7-2.3 2.9-4.8 10-2 3.1-2.3 2.7-2.7 2.2-2.7 1.7-3.7 1.5-3.1 0.2-5.9-12.6-0.8-2.5-0.1-2.7 0.3-2.7 0.9-4 2.3-7 0.5-6.1-1-6.3-2.1-7.2-4.2-3.3-5.6-3.3-4.4-4.3-0.2-6.8 4-3.7 5.9 0.8 10.4 5.3 2.1-0.3 7.9-5.7 3.6-0.1 1.5-0.8-0.6-1.5 5.2 0.5 1.9 16 6.9 4.2 4.9-7.2 5.7-6.5 6.7-4.4 6.9-3.8 5.8 7.6 1.6 6.2z"
      id="AZE1740"
      name="Zəngilan"
    ></path>,
    <path
      d="M9.4 510.2l-2.4-1.5-2.4-3.4-1.9-8.4-1.7-2.8 4.8-2.1 8-1.4 7.4 0.1 5.8-1.4 4.5-2.5 0 1.3-3.7 4.5-6.7 2-7 6.9-4.7 8.7z"
      id="AZE2415"
      name="Sədərək"
    ></path>,
    <path
      d="M170.5 662.6l3.2-5.6-5.1-5.2-6.1-4.4-0.4-2.2 0.8-2.1 0.6-4 1-3.6 7.2-9.1 6-13.1 1.6-4.2 1.1-4.3 0.8-3.8 1.1-3.5 3.6-3.8 3.4-4 4-5.2 9.7 4.8 3.5 3.3 1.1 1.8 0.4 1.6-0.4 1.6-5.2 6.9-1.1 5.6 1.6 5.8 3.6 6 4.4 6.3 3.5 7 8.8 24.9 10 19-1.7 0.2-9.9-2.5-11.3-5.1-35.9-7.6-3.9-1.5z"
      id="AZE2418"
      name="Ordubad"
    ></path>,
    <path
      d="M68.1 524.6l-3.7 11.8-3.1 13-5.6 9.1-7.5 5.5-6.1-4.2-1.6-2.6-1.3-0.4-2.7-0.1-4.4-3.2-0.6-1.5 1.4-2.7-3.6-3.2-2.1-4.4-5.1-21.3-2-4.8-3.6-2.6 1.2-1.6-4-0.1-3.6-0.8-0.7-0.3 4.7-8.7 7-6.9 6.7-2 3.7-4.5 0-1.3 1-0.6 6.3-4.9 6.4-2.2 5.8 3 12.5 16.1 1.8 3.7 0.7 4.1-0.2 5.2-1.7 8 0.7 3.2 3.3 2.2z"
      id="AZE2419"
      name="Şərur"
    ></path>,
    <path
      d="M111.8 540.4l-1.8 2.4-5.5 4.6-4.1 6.3 2.6 2 3.7 1.5 1.5 4.6 1.8 4.8 7.6 3.7 7.9 4 3.6 4.6-0.4 4.4 1.6 3 2.9-0.5 1.9 6.2-5.1 3.3-10.6 0.2-10.8 0.8-9.4-0.5-6.6 5.1 11.8 8.7 14.8-1.7 5.4 2 4.8 3.5-0.5 7.9-3.2 6.8 3.2 7.3 4.5 6.6-1 3-2.3 2.9 0.7 8.2-0.8-0.1-3.5-2.1-4.7-1.3-3.9-1.9-3.6-2.4-2-2.3-0.3-2.4 1.2-3.7 0.4-2.3-0.9-1.4-4-1.9-1.6-1.2-0.9-1.8-1.3-4.8-0.7-1.7-1.7-1.7-3-2.1-1.2-2.2 1.5-3.3-1-2.3-2.2-1.4-2.4-0.5-1.7-0.8 0.1-1.9 0.4-2.1-0.5-1.4-1.6-0.2-1.5 0.7-1.7 1.2-17.7-5.9-4.5 1.4-1.1-3.4-1.8-10.9-1.2-2.4-1.4-2.1-1-2.3 3.8 1.5 3.8 1.2 4.5-1.4 4.4-2.1 3.4-2.3 0.7-4.9-2.3-5.2 0.9-2.6 1.1-2.2-1.3-6.1-2.5-5.8-1.1-5.9 1.3-5.9 1.7-6.9 2.2-6.6 3.9-6.1 1.4-1.4 4.2 6 2 4.6 1.7 2.5 2.5 1 8.1 0.7 3 1.6 5.4 5.5z"
      id="AZE2420"
      name="Babək"
    ></path>,
    <path
      d="M193.3 584.5l-4 5.2-3.4 4-3.6 3.8-1.1 3.5-0.8 3.8-1.1 4.3-1.6 4.2-6 13.1-7.2 9.1-1 3.6-0.6 4-0.8 2.1 0.4 2.2 6.1 4.4 5.1 5.2-3.2 5.6-8.8-3.5-15.2-0.1-9.7-2.4-4.7-0.2-1.3-0.3-0.7-8.2 2.3-2.9 1-3-4.5-6.6-3.2-7.3 3.2-6.8 0.5-7.9-4.8-3.5-5.4-2 7.3-4.6 3.5-8 5.1-3.3-1.9-6.2 7.3-4.2 7.5-2.9 4.9-2.7 3.8 4.1 4.3 0.8 3.6-4.5 5.2-6.2 0.5 1 9.7 2.5 3.5 2.9 3.2 3.5 4.1 3.2 2.5 1.2z"
      id="AZE2421"
      name="Culfa"
    ></path>,
    <path
      d="M119.2 607.9l-14.8 1.7-11.8-8.7 6.6-5.1 9.4 0.5 10.8-0.8 10.6-0.2-3.5 8-7.3 4.6z"
      id="AZE2422"
      name="Naxçıvan"
    ></path>,
    <path
      d="M169.8 570.2l-5.2 6.2-3.6 4.5-4.3-0.8-3.8-4.1-4.9 2.7-7.5 2.9-7.3 4.2-2.9 0.5-1.6-3 0.4-4.4-3.6-4.6-7.9-4-7.6-3.7-1.8-4.8-1.5-4.6-3.7-1.5-2.6-2 4.1-6.3 5.5-4.6 1.8-2.4 1.8 1.1 1.9 0.3 2-0.4 3.7-1.7 13.7-8.8 4.6-1.9 21.8-5.3 4-0.1 4.7 1.8 3.9 2.8 1.5 2.8 0 3.8-0.5 5.6 1.5 10.1-0.7 3.5-5.8 9.5-1.1 4.4 1 2.3z"
      id="AZE2423"
      name="Şahbuz"
    ></path>,
    <path
      d="M342.8 470.7l-3.2 1.9-2.7-1.9-0.5-5.2 2.9-4.1 2.5-2.2 1.2-0.7 3 1.4 1.3 2.6-0.6 1.7-1.5 0.2-2.4 6.3z"
      id="AZE4838"
      name="Xankəndi"
    ></path>,
    <path
      d="M351.6 317.2l-1.5 0.1-1.1-1.1-0.6-1.4 2.7-3 2.3 2.1-0.2 2.2-1.6 1.1z"
      id="AZE5561"
      name="Naftalan"
    ></path>,
    <path
      d="M698.4 704.5l-2.7 3.6-2.3 1-0.9-1.5-0.4-2.9 0-6.8 3.5-2.2 2.8 6.9 0 1.9z"
      id="AZE5562"
      name="Lankaran"
    ></path>,
    <path
      d="M710 447.3l-2.4 2.3-1.3-0.5-1.1-1.2-3.2-1.5-1.2-1.6-1.3-3 0.1-3 0.5-6.6 2.5-0.8 3.7 1 4.5 0.2 2-0.3 1.6 1 0.7 1.9-0.2 6.6-2.3 2.7-2.6 2.8z"
      id="AZE5563"
      name="Shirvan"
    ></path>,
    <path
      d="M415.3 167.2l-2.5 1.3-7-1.9 0.4-3.5 1.5-4.7 1.2-4.3 1.2-3.6 1.9-1.5 2 1.5 3.5 6.1 0.5 4.6-2.7 6z"
      id="AZE5564"
      name="Şəki"
    ></path>,
    <path
      d="M342.5 482.2l-1.7 1-1.2 1.4-2.8 0.1-1.6-1.2-0.2-2.4 1.4-2.3 3 0.8 3.1 2.6z"
      id="AZE5565"
      name="Şuşa"
    ></path>,
    <path
      d="M411.8 298.3l-1.6 2.3-5.9-0.3-5.4-3.2-2.4-7.3 3-4.8 7.8 0 3.7-0.2 1.9 0.2 0.8 0.7-0.3 2.9-1.7 4-0.4 1.6 0.1 2.7 0.4 1.4z"
      id="AZE5566"
      name="Yevlakh"
    ></path>,
    <path
      d="M84.9 518.5l-1.4 1.4-3.9 6.1-2.2 6.6-1.7 6.9-1.3 5.9 1.1 5.9 2.5 5.8 1.3 6.1-1.1 2.2-0.9 2.6 2.3 5.2-0.7 4.9-3.4 2.3-4.4 2.1-4.5 1.4-3.8-1.2-3.8-1.5-3.2-7.1-1.3-2.1-1.6-0.9-1.7-2.1-1.4-2.2-0.6-1.6-1-1.2 7.5-5.5 5.6-9.1 3.1-13 3.7-11.8 6.3-1.5 4.8-4.6 4.6-1.5 1.1 1.5z"
      id="AZE5567"
      name="Kangarli"
    ></path>,
  ];
  ...
  const handleMouseMove = (e: React.MouseEvent<SVGGElement, MouseEvent>) => {
    ...
    const cityName =
      e.currentTarget.attributes.getNamedItem("data-name")?.value;
    cityName && setCity({ name: cityName, clientX, clientY });
  };

  const handleMouseLeave = () => {
    setMouseLeave(!isMouseLeave);
  };
  ...
  return (
    <div className="flex justify-center pt-20 transition-all">
      <div
        style={{
          display: `${isMouseEnter === isMouseLeave ? "none" : "block"}`,
          top: city.clientY - 20,
          left: city.clientX + 20,
        }}
        className={`hidden absolute bg-gray-100 px-5 py-1 text-sm rounded`}
      >
        {city.name}
      </div>
      <svg
      ...
      >
        {cities.map((city) => (
          <Link to={`/city/${city.props.name}`} key={city.props.id}>
            <g
              className="hover:fill-indigo-600 transition-all fill-indigo-400"
              onMouseMove={handleMouseMove}
              onMouseLeave={handleMouseLeave}
              onMouseEnter={handleMouseEnter}
              data-name={city.props.name}
            >
              {city}
            </g>
          </Link>
